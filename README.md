[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-24ddc0f5d75046c5622901739e7c5dd533143b0c8e959d652212380cedb1ea36.svg)](https://classroom.github.com/a/wsPYx8Tc)
# Final Project Bisnis
...
---
## Problems
<p align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Terdapat data keuntungan beberapa cabang rumah sakit, jumlah pasien yang berkunjung, dan tingkat kepuasan pasien. Dari indikator tersebut dapat ditentukan indeks prestasi rumah sakit. Setelah poin indeks prestasi rumah sakit diketahui, pihak management dapat lebih aware antara cabang dengan indeks prestasi yang sudah diatas batas, serta indeks prestasi yang masih di bawah batas. Hal tersebut dapat membantu pihak manajemen agar masing-masing cabang rumah sakit tidak mengalami ketimpangan indeks prestasi melalui evaluasi. Hal tersebut dapat meningkatkan tingkat kepuasan pasien pada rumah sakit.</p>
...
| --- | --- | --- | --- |
| Sumber Data | 1. Tabel disediakan untuk semua informasi dengan 3 cabang rumah sakit <br/>2. Input data ke database local <br/>3. Membuat schedule job <br/>4. Membuat tabel yang sesuai dengan analisa <br/>5. Cleansing data (DDL dan DML SQL) | 1. Data biaya (obat, kamar, tindakan, administrasi, dokter, perawatan, makanan) <br/>2. Data pasien berkunjung (rawat inap dan rawat jalan) <br/>3. Data tingkat kepuasan pasien | 25 pts
| Program | 1. Tabel yang sesuai dengan analisa dipastikan kembali sudah sesuai <br/>2. Tabel dipecah menjadi kategori tabel sesuai kebutuhan<br/>3. Membuat ERD relasi one to many / many to many<br/>4. Menampilkan grafik analisa (Python)<br/>5. Menampilkan grafik prediksi (ML)<br/> | 1. Membuat indicator penilaian dari data yang ada, setiap kolom dinilai dari 1-10 <br/>2. Menentukan nilai mean dari semua kolom untuk masing-masing cabang rumah sakit (indicator standart adalah 7)| 25 pts |
| Proposal | 1. Terdiri atas : latar belakang, rumusan masalah, pembahasan (program lengkap dari awal hingga akhir disertai keterangan, gambar visualisasi, dan interpretasi), prediksi <br/>2. Karakter penulisan : Times new roman, ukuran 12, paragraph justify, spacing 1.0.| 1. Menentukan cabang rumah sakit yang diatas rata-rata dan dibawah rata-rata <br/>2. Memberikan insight kepada cabang rumah sakit sesuai kategori nilainya | 25 pts |
| PPT | 1. Berisi poin sesuai kerangka (ringkas dan jelas) minim tulisan. <br/>2. Terdiri dari gambar yang interpretative <br/>3. Alur menggunakan diagram <br/>4. Berisi : latar belakang, rumusan masalah, solusi, dan evaluasi.| 1. Visualisasi hasil nilai per cabang rumah sakit <br/>2. Visualisasi insight untuk percabang rumah sakit <br/>3. Alasan menggunakan grafik dan interpretasinya | 25 pts |
